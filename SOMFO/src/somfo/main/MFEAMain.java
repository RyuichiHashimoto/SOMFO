...
import somfo.metaheuristics.mfea.MFEA;
...
public class MFEAMain extends AlgorithmMain{

	public MFEAMain(Setting test) {
		super(test);
	}
	...
	public void setParameter() throws NameNotFoundException, ClassNotFoundException, JMException {
		...
		Operator Mutation;
		Operator Crossover;
		DirectoryName = "result/MFEA/" + taskname;
		algorithm = new Algorithm[1];
		algorithm[0] = new MFEA(problem_);
