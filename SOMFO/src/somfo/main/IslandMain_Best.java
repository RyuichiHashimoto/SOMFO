...
import somfo.metaheuristics.IslandModelSOEA_best.IslandModelSOEA_Best;
...
public class IslandMain_Best extends AlgorithmMain{

	public IslandMain_Best(Setting test) {
		super(test);
	}
	...
	public void setParameter() throws NameNotFoundException, ClassNotFoundException, JMException {
		...
		Operator Mutation;
		Operator Crossover;
		DirectoryName = "result/Island_best/" + taskname;
		algorithm = new Algorithm[1];
		algorithm[0] = new IslandModelSOEA_Best(problem_);
...
//		algorithm[0].setInputParameter("tasknumber", "Task" + String.valueOf(i+1) );
		DirectoryName = "result/Island_best" +"/every" + setting_.getAsStr("every") +"amount" + setting_.getAsStr("amount")+"/"+ taskname;
