...
import somfo.metaheuristics.IslandModelSOEA.IslandModelSOEA;
...
public class IslandMain extends AlgorithmMain{
	...
	public void setParameter() throws NameNotFoundException, ClassNotFoundException, JMException {
		...
		Operator Mutation;
		Operator Crossover;
		DirectoryName = "result/Island/" + taskname;
		algorithm = new Algorithm[1];
		algorithm[0] = new IslandModelSOEA(problem_);
...
//		algorithm[0].setInputParameter("tasknumber", "Task" + String.valueOf(i+1) );
		DirectoryName = "result/Island" +"/every" + setting_.getAsStr("every") +"amount" + setting_.getAsStr("amount")+"/"+ taskname;
