...
import somfo.metaheuristics.mergeSOEA.MergeSOEA;
...
public class MergeMain extends AlgorithmMain{

	public MergeMain(Setting test) {
		super(test);
	}
	...
	public void setParameter() throws NameNotFoundException, ClassNotFoundException, JMException {
		...
		Operator Mutation;
		Operator Crossover;
		DirectoryName = "result/Merge/" + taskname;
		algorithm = new Algorithm[1];
		algorithm[0] = new MergeSOEA(problem_);
...
//		algorithm[0].setInputParameter("tasknumber", "Task" + String.valueOf(i+1) );
		DirectoryName = "result/Merge" +"/every" + setting_.getAsStr("every") +"/"+ taskname;
