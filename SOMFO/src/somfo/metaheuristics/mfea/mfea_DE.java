...
public class mfea_DE extends Algorithm{
	...
	public mfea_DE(ProblemSet problem) {
		super(problem);
	}
...
//		int maxEvaluations = ((Integer) this.getInputParameter("maxEvaluations")).intValue();
		...
		for(int i = 0; i< problemSet_.size();i++){
			...
			fileSubscription.printToFile("result/" + "MFEADE" + "/" + name + "/Task"+ (i+1) +"/Different/"+ taskName + (time)+ ".dat", number[i], populationSize_/problemSet_.size());
			fileSubscription.printToFile("result/" + "MFEADE" + "/" + name + "/Task"+ (i+1)+"/BestFUN/" + taskName + (time )+ ".dat", best[i], populationSize_/problemSet_.size());
			fileSubscription.printToFile("result/" + "MFEADE" + "/" + name + "/Task"+ (i+1)+"/WorstFUN/"+ taskName + (time )+ ".dat", worst[i], populationSize_/problemSet_.size());
			population_.printVariablesToFile("result/" + "MFEADE" + "/" + name + "/Task"+ (i+1)+"/BESTVAR/"+ taskName + (time )+ ".dat");
		}
