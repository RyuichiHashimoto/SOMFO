...
if __name__ =="__main__":
    print("delete")
    TARGETDIRECTORY = "result/SOEA/CILS/Task2";
    DIRECTORY = getAllFileName(TARGETDIRECTORY,"average.dat");    
    for file in DIRECTORY:
        os.remove(file);
    DIRECTORY = getAllFileName(TARGETDIRECTORY,"log_average.dat");    
    for file in DIRECTORY:
        os.remove(file);
    print("FILES")
    SubscriptAverage(TARGETDIRECTORY,"BestFUN");
    DIRECTORY = getAllFileName(TARGETDIRECTORY,"average.dat");    
    #print("file")
    for file in DIRECTORY:
    #    print("file");
